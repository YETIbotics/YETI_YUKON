...
LIFT::LIFT(ROBOT &refRobot) : Robot(refRobot)//, LiftEnc(Robot._LiftEnc0, Robot._LiftEnc1)//, Lift(0, &Robot.pwm, true) // Lift(0, Robot._LiftPWM, true)
{
}
void LIFT::Loop()
{
    Robot.LiftMotor.SetMotorSpeed(Robot.State.LiftSpeed);
}
// void LIFT::Loop()
// {
